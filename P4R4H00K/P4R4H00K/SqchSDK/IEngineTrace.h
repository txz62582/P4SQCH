...
namespace SSDK {
	...
	public:
		int GetPointContents(const Vector &vecAbsPosition, int contentsMask = MASK_ALL, IHandleEntity** ppEntity = NULL) {
			typedef int(__thiscall *OrigFn)(void*, const Vector &, int, IHandleEntity**);
			return CallVFunction<OrigFn>(this, 0)(this, vecAbsPosition, contentsMask, ppEntity);
		}

		void TraceRay(const Ray_t &ray, unsigned int fMask, ITraceFilter *pTraceFilter, CGameTrace *pTrace) {
			typedef void(__thiscall *OrigFn)(void*, const Ray_t&, unsigned int, ITraceFilter*, CGameTrace*);
			CallVFunction<OrigFn>(this, 5)(this, ray, fMask, pTraceFilter, pTrace);
		}
		...
		void ClipRayToEntity(const Ray_t &ray, unsigned int fMask, IHandleEntity *pEnt, CGameTrace *pTrace) {
			...
			CallVFunction<OrigFn>(this, 3)(this, ray, fMask, pEnt, pTrace);
		}
	};
}