...
namespace SSDK {
	...
	public:
		...
		MaterialHandle_t FirstMaterial() {
			typedef MaterialHandle_t(__thiscall *OrigFn)(void*);
			return CallVFunction<OrigFn>(this, 86)(this);
		};

		MaterialHandle_t NextMaterial(MaterialHandle_t h) {
			typedef MaterialHandle_t(__thiscall *OrigFn)(void*, MaterialHandle_t);
			return CallVFunction<OrigFn>(this, 87)(this, h);
		};

		MaterialHandle_t InvalidMaterial() {
			typedef MaterialHandle_t(__thiscall *OrigFn)(void*);
			return CallVFunction<OrigFn>(this, 88)(this);
		};

		IMaterial *GetMaterial(MaterialHandle_t h) {
			typedef IMaterial*(__thiscall *OrigFn)(void*, MaterialHandle_t);
			return CallVFunction<OrigFn>(this, 89)(this, h);
		};
	private:
		int created = 0;
	};
